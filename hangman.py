...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    print('Welcome to the game Hangman!\nI am thinking of a word that is {} letters long.\n'
          'You have {} warnings left.'.format(length, warnings))
    print('-' * 35)
    while not is_word_guessed(secret_word, letters_guessed) and guesses > 0:
      print('You have {} guesses left.\nAvailable letters: {}'.format(guesses, get_available_letters(letters_guessed)))
    ...
    if guesses == 0:
      ...
      #By using set(secret_word) we get a set of unique letters of secret word
      score = guesses * unique
    ...
    if len(my_word) == len(other_word):
      for i in range(len(my_word)):
        ...
        if my_word[i] != '_' and my_word[i] != other_word[i]:
          return False
        elif my_word[i] == '_' and other_word[i] in checking:
          return False
      return True
    else:
      return False
...
choice = input('Make your choice!\nTo play classic hangman enter "classic"\nTo play hangman with hints enter "hints" ').lower()
while True:
  if choice == 'classic':
    ...
    choice = input('Ooh! Something went wrong.\nTo play classic hangman enter "classic"\nTo play hangman with hints enter "hints" ').lower()
